...
Read(${COPILOT_PLUGIN_ROOT}/sdd/templates/BRAINSTORM_TEMPLATE.md)
...
- Agent: `${COPILOT_PLUGIN_ROOT}/agents/workflow-brainstorm.agent.md`
- Template: `${COPILOT_PLUGIN_ROOT}/sdd/templates/BRAINSTORM_TEMPLATE.md`
- Contracts: `${COPILOT_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `${COPILOT_PLUGIN_ROOT}/skills/workflow-define/SKILL.md`
