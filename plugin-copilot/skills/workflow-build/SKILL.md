...
- Agent: `${COPILOT_PLUGIN_ROOT}/agents/workflow-build.agent.md`
- Template: `${COPILOT_PLUGIN_ROOT}/sdd/templates/BUILD_REPORT_TEMPLATE.md`
- Contracts: `${COPILOT_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `${COPILOT_PLUGIN_ROOT}/skills/workflow-ship/SKILL.md`
