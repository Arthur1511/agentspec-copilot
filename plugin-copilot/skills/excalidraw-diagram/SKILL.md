...
```bash
cd ${COPILOT_PLUGIN_ROOT}/skills/excalidraw-diagram/references && uv run python render_excalidraw.py <path-to-file.excalidraw>
```
...
```bash
cd ${COPILOT_PLUGIN_ROOT}/skills/excalidraw-diagram/references
uv sync
