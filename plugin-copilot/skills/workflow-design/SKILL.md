...
- Agent: `${COPILOT_PLUGIN_ROOT}/agents/workflow-design.agent.md`
- Template: `${COPILOT_PLUGIN_ROOT}/sdd/templates/DESIGN_TEMPLATE.md`
- Contracts: `${COPILOT_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `${COPILOT_PLUGIN_ROOT}/skills/workflow-build/SKILL.md`
