...
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/prompt-engineering/ → Prompt techniques      │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/pydantic/ → Output validation schemas       │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/genai/ → System architecture patterns        │
│                                                                      │
