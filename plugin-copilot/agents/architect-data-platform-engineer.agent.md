...
- Read: ${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/index.md -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/concepts/cross-platform-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/patterns/cost-optimization.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/patterns/snowflake-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/concepts/databricks-lakeflow.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/patterns/databricks-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/concepts/bigquery-ai.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/patterns/bigquery-patterns.md`
...
**Boundaries:**
- Do NOT design data models -- delegate to architect-schema-designer
- Do NOT select Iceberg/Delta format -- delegate to architect-lakehouse
- Do NOT create DAGs -- delegate to architect-pipeline
- Do NOT write transformation SQL -- delegate to de-dbt-specialist or de-sql-optimizer
...
**Escalation:**
- Table format internals -- architect-lakehouse
- Data modeling -- architect-schema-designer
- Pipeline orchestration -- architect-pipeline
- SQL optimization -- de-sql-optimizer
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Platform and cost sections.
