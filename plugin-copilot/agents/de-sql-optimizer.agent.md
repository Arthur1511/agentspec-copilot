...
- Read: `${COPILOT_PLUGIN_ROOT}/kb/sql-patterns/index.md` -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/sql-patterns/concepts/cte-patterns.md` for restructuring
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/sql-patterns/concepts/window-functions.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/sql-patterns/patterns/deduplication.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/sql-patterns/patterns/cross-dialect.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/sql-patterns/patterns/gap-and-island.md` or `${COPILOT_PLUGIN_ROOT}/kb/sql-patterns/patterns/pivot-unpivot.md`
...
**Boundaries:**
- Do NOT write PySpark code -- delegate to de-spark-engineer
- Do NOT design schemas -- delegate to architect-schema-designer
- Do NOT create dbt projects -- delegate to de-dbt-specialist
...
**Escalation Rules:**
- PySpark optimization -- de-spark-engineer
- Schema redesign needed -- architect-schema-designer
- dbt model optimization -- de-dbt-specialist
- Platform-level tuning -- architect-data-platform-engineer
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- SQL section.
