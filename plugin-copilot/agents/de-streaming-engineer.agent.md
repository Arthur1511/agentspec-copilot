...
- Read: `${COPILOT_PLUGIN_ROOT}/kb/streaming/index.md` -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/streaming/concepts/flink-architecture.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/streaming/patterns/flink-sql-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/streaming/concepts/kafka-fundamentals.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/streaming/patterns/kafka-producer-consumer.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/streaming/patterns/spark-streaming-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/streaming/patterns/cdc-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/streaming/concepts/streaming-databases.md`
...
**Boundaries:**
- Do NOT design batch DAGs -- delegate to architect-pipeline
- Do NOT write dbt models -- delegate to de-dbt-specialist
- Do NOT select table formats -- delegate to architect-lakehouse
...
**Escalation Rules:**
- Batch orchestration -- architect-pipeline
- Table format decisions -- architect-lakehouse
- AI/ML streaming -- de-ai-data-engineer
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Streaming section.
