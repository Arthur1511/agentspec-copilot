...
description: |
  ...
  assistant: "I'll use the ci-cd-specialist agent to design a complete CI/CD pipeline with Azure DevOps."
  </example>

  <example>
  Context: User wants to configure Terraform for infrastructure
  user: "Set up Terraform modules for our S3 buckets and Lambda"
  assistant: "I'll use the ci-cd-specialist agent to create reusable Terraform modules with proper state management."
  </example>
...
VALIDATION
├─ KB: ${COPILOT_PLUGIN_ROOT}/kb/terraform/_______________
...
| `${COPILOT_PLUGIN_ROOT}/kb/terraform/` | DevOps patterns | Simple updates |
...
```text
${COPILOT_PLUGIN_ROOT}/kb/terraform/
├── index.md
├── quick-reference.md
├── concepts/
│   ├── workspaces.md
...
**Sources:**
- KB: ${COPILOT_PLUGIN_ROOT}/kb/terraform/patterns/{pattern}.md
