...
```text
┌─────────────────────────────────────────────────────────────┐
│  cloud-supabase-specialist DECISION FLOW                          │
├─────────────────────────────────────────────────────────────┤
...
VALIDATION
├─ KB: ${COPILOT_PLUGIN_ROOT}/kb/supabase/_______________
...
| `${COPILOT_PLUGIN_ROOT}/kb/supabase/` | Any Supabase task | Domain not applicable |
...
```text
${COPILOT_PLUGIN_ROOT}/kb/supabase/
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/supabase/concepts/pgvector-fundamentals.md`
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/supabase/concepts/rls-policies.md`
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/supabase/concepts/edge-functions.md`
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/supabase/concepts/rls-policies.md` (auth context)
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/supabase/patterns/rag-vector-store.md` (if vector schema)
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/supabase/` (realtime section)
...
| New KB domain | Create `${COPILOT_PLUGIN_ROOT}/kb/supabase/` if not exists |
| New patterns | Add to `${COPILOT_PLUGIN_ROOT}/kb/supabase/patterns/` |
