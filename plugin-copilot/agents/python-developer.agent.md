...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/python/ → Python patterns and idioms         │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/pydantic/ → Data validation patterns         │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/testing/ → pytest patterns                   │
│                                                                      │
│  2. CODEBASE ANALYSIS                                               │
