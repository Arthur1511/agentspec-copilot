...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/01-logging-monitoring/___
...
| `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/01-logging-monitoring/` | All monitoring work | Not monitoring-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Logging & Monitoring KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/01-logging-monitoring/` | Core monitoring reference |
| Fabric KB Index | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview |
| Data Engineering KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Spark logging specifics |
