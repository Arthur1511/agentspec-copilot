...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/_______________
...
| `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/` | Any Qdrant task | Domain not applicable |
| `${COPILOT_PLUGIN_ROOT}/kb/genai/` | n8n integration tasks | Pure API work |
| `${COPILOT_PLUGIN_ROOT}/kb/genai/` | RAG architecture design | Simple CRUD operations |
...
```text
${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/vector-databases.md`
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/quick-reference.md`
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
2. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/genai/concepts/multi-agent-systems.md`
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
2. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/genai/concepts/rag-architecture.md`
...
| New KB concept | Create `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/{name}.md` |
| New KB pattern | Create `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/{name}.md` |
