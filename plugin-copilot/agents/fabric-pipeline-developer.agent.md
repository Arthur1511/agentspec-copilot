...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/___
...
| `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | All pipeline work | Not pipeline-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Data Engineering KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Core pipeline reference |
| Architecture Patterns KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/03-architecture-patterns/` | Pipeline architecture |
