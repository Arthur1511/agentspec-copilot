...
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/genai/ → Multi-agent, RAG, state machines   │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/prompt-engineering/ → Prompt patterns        │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/ → Data pipeline AI      │
│                                                                      │
