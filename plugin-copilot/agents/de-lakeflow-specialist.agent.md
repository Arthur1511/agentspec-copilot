...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/lakeflow/ → DLT pipelines, expectations     │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/lakehouse/ → Delta Lake, catalog patterns    │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/spark/ → Spark SQL, DataFrame patterns       │
│                                                                      │
