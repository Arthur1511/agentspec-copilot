...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/medallion/ → Layer design patterns           │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/data-modeling/ → Schema patterns             │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/lakehouse/ → Storage format patterns         │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/data-quality/ → Quality progression          │
│                                                                      │
