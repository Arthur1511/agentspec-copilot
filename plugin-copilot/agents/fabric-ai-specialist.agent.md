...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/___
...
| `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/` | All AI work | Not AI-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| AI Capabilities KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/` | Core AI reference |
| Data Engineering KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Spark/notebook patterns |
