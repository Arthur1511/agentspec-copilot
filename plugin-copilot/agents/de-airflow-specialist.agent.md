...
```text
┌─────────────────────────────────────────────────────────────┐
│  de-airflow-specialist DECISION FLOW                           │
├─────────────────────────────────────────────────────────────┤
...
VALIDATION
├─ KB: ${COPILOT_PLUGIN_ROOT}/kb/_______________  (cross-domain: no dedicated KB, uses project KB)
...
| `${COPILOT_PLUGIN_ROOT}/kb/` | Domain-related work | Not pipeline-related |
...
|--------|----------|---------|
| `${COPILOT_PLUGIN_ROOT}/kb/` (if applicable) | Primary | Project-specific patterns and conventions |
