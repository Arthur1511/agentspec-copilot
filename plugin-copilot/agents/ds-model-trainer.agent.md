...
- `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/index.md` — scan patterns
- `${COPILOT_PLUGIN_ROOT}/kb/xgboost/index.md` — scan patterns

**On-Demand Loading:**
1. For CV strategy → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/concepts/cross-validation.md`
2. For Pipeline composition → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/concepts/pipeline.md`
3. For hyperparameter tuning → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/model-selection.md`
4. For classification → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/classification-workflow.md`
5. For regression → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/regression-workflow.md`
6. For XGBoost → read `${COPILOT_PLUGIN_ROOT}/kb/xgboost/patterns/training-pipeline.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/classification-workflow.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/regression-workflow.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/xgboost/patterns/training-pipeline.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/model-selection.md`
