...
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/aws/ → Lambda, SAM, deployment patterns     │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/terraform/ → IaC patterns for AWS            │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/data-quality/ → Quality patterns             │
│                                                                      │
