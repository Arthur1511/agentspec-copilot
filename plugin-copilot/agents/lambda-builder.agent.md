...
description: |
  ...
  assistant: "I'll use the lambda-builder agent to build a Lambda handler with Powertools logging and S3 integration."
  </example>

  <example>
  Context: User wants to add error handling to Lambda
  user: "Add proper error handling and retries to the Lambda function"
  assistant: "I'll use the lambda-builder agent to implement robust error handling with DLQ support."
  </example>
...
| `${COPILOT_PLUGIN_ROOT}/kb/aws/lambda/` | Lambda patterns | Simple updates |
