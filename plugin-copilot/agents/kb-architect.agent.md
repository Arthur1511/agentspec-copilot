...
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/_index.yaml → KB manifest                   │
│     └─ Glob: ${COPILOT_PLUGIN_ROOT}/kb/{domain}/**/*.md → Existing content         │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/_templates/ → File templates                │
│                                                                      │
...
```markdown
**KB Domain Created:** `${COPILOT_PLUGIN_ROOT}/kb/{domain}/`
