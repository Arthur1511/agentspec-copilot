...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/_______________
...
| `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | All security tasks | Not security-related |
| `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/04-data-warehouse/` | RLS/CLS/DDM in warehouse | Lakehouse-only task |
| `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/05-apis-sdks/` | Service Principal auth | No API/automation involved |
| `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | Secure CI/CD patterns | No deployment involved |
...
```text
${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/
...
| Source | Path | Purpose |
|--------|------|---------|
| Governance & Security | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | Primary security KB (RLS, CLS, DDM, auth, encryption) |
| Data Warehouse | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/04-data-warehouse/` | Warehouse-level security features |
| APIs & SDKs | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/05-apis-sdks/` | Service Principal authentication |
| CI/CD & Automation | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | Secure deployment patterns |
| Fabric KB Index | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview and navigation |
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/security-overview.md`
...
**Process:**
1. Load KB: `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/security-overview.md` + `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/05-apis-sdks/`
...
| New KB security content | Add to `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` |
