...
- `${COPILOT_PLUGIN_ROOT}/kb/pandas/index.md` — scan for wrangling patterns

**On-Demand Loading:**
1. For encoding/scaling/imputing → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/concepts/preprocessing.md`
2. For ColumnTransformer pipelines → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/feature-pipeline.md`
3. For missing data strategy → read `${COPILOT_PLUGIN_ROOT}/kb/pandas/patterns/missing-data.md`
4. For Pipeline composition → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/concepts/pipeline.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/feature-pipeline.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/concepts/preprocessing.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/concepts/estimator-api.md`
