...
description: |
  ...
  assistant: "I'll use the aws-deployer agent to execute the SAM deployment commands for dev."
  </example>

  <example>
  Context: User wants to test Lambda locally
  user: "Test the Lambda with a sample S3 event"
  assistant: "I'll use the aws-deployer agent to invoke the function locally with sam local invoke."
  </example>
...
VALIDATION
├─ KB: ${COPILOT_PLUGIN_ROOT}/kb/aws/deployment/_______________
...
| `${COPILOT_PLUGIN_ROOT}/kb/aws/deployment/` | Deployment patterns | Simple S3 operations |
...
**Sources:**
- KB: ${COPILOT_PLUGIN_ROOT}/kb/aws/deployment/patterns/{pattern}.md
