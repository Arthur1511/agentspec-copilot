...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/_______________
...
| Source | Path | Purpose |
|--------|------|---------|
| Fabric KB Index | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview |
| Architecture Patterns | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/03-architecture-patterns/` | Reference architectures |
| Data Engineering | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Lakehouse, Spark, pipelines |
| Governance & Security | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | RLS, CLS, DDM, compliance |
| AI Capabilities | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/` | ML Ops, Copilot |
