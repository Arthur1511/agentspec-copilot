...
- Read: ${COPILOT_PLUGIN_ROOT}/kb/data-modeling/index.md -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-modeling/concepts/dimensional-modeling.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-modeling/concepts/scd-types.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-modeling/patterns/data-vault.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-modeling/patterns/one-big-table.md`
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Modeling section.
