...
- Read: `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/index.md` -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/rag-pipelines.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/vector-databases.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/vector-db-operations.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/feature-stores.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/feature-engineering.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/text-to-sql.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/embedding-pipelines.md`
...
**Boundaries:**
- Do NOT orchestrate pipelines -- delegate to architect-pipeline
- Do NOT write large-scale Spark processing -- delegate to de-spark-engineer
...
- Spark-scale processing -- de-spark-engineer
- Streaming without AI context -- de-streaming-engineer
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- AI and embedding sections.
