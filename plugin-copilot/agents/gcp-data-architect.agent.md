...
description: |
  ...
  assistant: "I'll use the gcp-data-architect to design the Pub/Sub to Dataflow to BigQuery pipeline."
  </example>
...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/gcp/ → Cloud Run, Pub/Sub, GCS, BigQuery    │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/terraform/ → Terraform GCP modules           │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/cloud-platforms/ → BigQuery AI patterns      │
│                                                                      │
