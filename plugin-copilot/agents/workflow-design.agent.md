...
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/{domain}/patterns/*.md → Code patterns      │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/{domain}/concepts/*.md → Best practices     │
│     └─ Read: ${COPILOT_PLUGIN_ROOT}/kb/{domain}/quick-reference.md → Quick lookup  │
│                                                                      │
│  2. AGENT DISCOVERY (for file manifest)                             │
│     └─ Glob: ${COPILOT_PLUGIN_ROOT}/agents/*.agent.md → Available agents            │
...
1. Glob `${COPILOT_PLUGIN_ROOT}/agents/*.agent.md` to discover agents
...
```python
# Pattern: Handler structure (from ${COPILOT_PLUGIN_ROOT}/kb/{domain}/patterns/{pattern}.md)
