...
description: |
  ...
  assistant: "I'll use the ai-data-engineer-cloud agent to analyze and optimize."
  </example>
...
VALIDATION
├─ KB: ${COPILOT_PLUGIN_ROOT}/kb/_______________  (cross-domain: loads relevant KB per task)
...
| `${COPILOT_PLUGIN_ROOT}/kb/` (project KB) | Pipeline work | Not data-related |
