...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/___
...
| Source | Path | Purpose |
|--------|------|---------|
| CI/CD KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | Core CI/CD reference |
| Fabric KB Index | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview |
| Governance KB | `${COPILOT_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | Service Principal auth |
