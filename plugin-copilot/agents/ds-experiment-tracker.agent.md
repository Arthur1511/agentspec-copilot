...
```
Load: ${COPILOT_PLUGIN_ROOT}/kb/mlflow/_index.yaml → scan domains
Load: ${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/_index.yaml → Pipeline integration patterns
Load: ${COPILOT_PLUGIN_ROOT}/kb/xgboost/_index.yaml → autologging patterns
```

### Step 2 — On-Demand Loading
| Trigger | Files to Load |
|---|---|
| "log run", "autolog", "start_run" | `${COPILOT_PLUGIN_ROOT}/kb/mlflow/concepts/experiment-tracking.md` |
| "register", "model registry", "stage", "promote" | `${COPILOT_PLUGIN_ROOT}/kb/mlflow/concepts/model-registry.md`, `${COPILOT_PLUGIN_ROOT}/kb/mlflow/patterns/model-versioning.md` |
| "artifact", "figure", "save model" | `${COPILOT_PLUGIN_ROOT}/kb/mlflow/concepts/artifact-logging.md` |
| "search runs", "best run", "compare" | `${COPILOT_PLUGIN_ROOT}/kb/mlflow/concepts/run-management.md`, `${COPILOT_PLUGIN_ROOT}/kb/mlflow/patterns/experiment-comparison.md` |
| "sklearn", "pipeline", "cross-val" | `${COPILOT_PLUGIN_ROOT}/kb/mlflow/patterns/sklearn-integration.md` |
| "nested run", "sweep", "optuna" | `${COPILOT_PLUGIN_ROOT}/kb/mlflow/concepts/run-management.md` |
