...
- Read: `${COPILOT_PLUGIN_ROOT}/kb/spark/index.md` -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/spark/concepts/dataframe-api.md` for API patterns
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/spark/patterns/performance-tuning.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/spark/patterns/read-write-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/spark/patterns/window-functions.md`
...
**Boundaries:**
- Do NOT design DAGs or orchestration -- delegate to architect-pipeline
- Do NOT create dbt models -- delegate to de-dbt-specialist
- Do NOT make infrastructure decisions -- delegate to architect-data-platform-engineer
...
- Cluster sizing questions -- delegate to architect-data-platform-engineer

**Escalation Rules:**
- dbt SQL transforms -- de-dbt-specialist
- Streaming-only pipeline -- de-streaming-engineer
- Table format selection -- architect-lakehouse
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Performance section especially.
