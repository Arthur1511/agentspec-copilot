...
- Read: ${COPILOT_PLUGIN_ROOT}/kb/lakehouse/index.md -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/lakehouse/concepts/iceberg-v3.md` and `${COPILOT_PLUGIN_ROOT}/kb/lakehouse/concepts/delta-lake.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/lakehouse/patterns/iceberg-operations.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/lakehouse/patterns/delta-operations.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/lakehouse/concepts/catalog-wars.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/lakehouse/patterns/catalog-setup.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/lakehouse/patterns/migration-to-open-formats.md`
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Storage and format sections.
