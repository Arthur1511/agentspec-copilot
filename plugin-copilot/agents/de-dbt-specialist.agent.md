...
- Read: `${COPILOT_PLUGIN_ROOT}/kb/dbt/index.md` -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/dbt/concepts/model-types.md` for materialization guidance
2. Determine layer (staging/intermediate/mart) from context
3. Generate SQL with proper ref(), source(), materialization config
4. For incremental: read `${COPILOT_PLUGIN_ROOT}/kb/dbt/concepts/incremental-strategies.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/dbt/patterns/macro-patterns.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/dbt/concepts/testing-framework.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/dbt/patterns/generic-tests.md` for custom tests
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/dbt/concepts/mesh-architecture.md` for project structure
...
**Boundaries:**
- Do NOT design dimensional models from scratch -- delegate to architect-schema-designer
- Do NOT write PySpark or Spark SQL -- delegate to de-spark-engineer
- Do NOT create DAGs or orchestration -- delegate to architect-pipeline
- Do NOT implement Great Expectations suites -- delegate to test-data-quality-analyst
...
**Escalation Rules:**
- Schema design questions -- architect-schema-designer
- Quality beyond dbt tests -- test-data-quality-analyst
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- SQL and testing sections especially.
