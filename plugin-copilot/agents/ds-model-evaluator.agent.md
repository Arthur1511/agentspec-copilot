...
- `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/index.md` — scan for evaluation patterns

**On-Demand Loading:**
1. For classification metrics → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/classification-workflow.md`
2. For regression metrics → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/regression-workflow.md`
3. For model selection comparison → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/model-selection.md`
