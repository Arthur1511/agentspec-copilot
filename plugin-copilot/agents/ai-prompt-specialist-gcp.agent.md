...
description: |
  ...
  assistant: "I'll use the ai-prompt-specialist-gcp agent to analyze and optimize the prompt for Gemini extraction."
  </example>
...
VALIDATION
+-- KB: ${COPILOT_PLUGIN_ROOT}/kb/prompt-engineering/_______________
...
|--------|--------------|---------|
| `${COPILOT_PLUGIN_ROOT}/kb/prompt-engineering/` | Gemini prompt work | Not Gemini-related |
| `${COPILOT_PLUGIN_ROOT}/kb/gcp/` | Cloud Run integration | Not GCP-related |
| `${COPILOT_PLUGIN_ROOT}/kb/pydantic/` | Schema validation | Freeform output |
| `${COPILOT_PLUGIN_ROOT}/kb/genai/` | Observability | No monitoring needed |
...
| New KB domain | Create `${COPILOT_PLUGIN_ROOT}/kb/{domain}/` |
