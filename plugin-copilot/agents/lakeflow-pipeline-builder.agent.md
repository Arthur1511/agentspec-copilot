...
description: |
  ...
  assistant: "I'll use the lakeflow-pipeline-builder to build the Bronze/Silver/Gold pipeline for entities."
  </example>

  <example>
  Context: User asks about data quality expectations
  user: "Add data quality checks to the silver layer"
  assistant: "I'll use the lakeflow-pipeline-builder to add DLT expectations for data validation."
  </example>
...
VALIDATION
├─ KB: ${COPILOT_PLUGIN_ROOT}/kb/lakeflow/_______________
...
| `${COPILOT_PLUGIN_ROOT}/kb/lakeflow/` | Lakeflow pipeline work | Not DLT-related |
...
```text
${COPILOT_PLUGIN_ROOT}/kb/lakeflow/
...
1. Load: `Read(${COPILOT_PLUGIN_ROOT}/kb/lakeflow/patterns/bronze-ingestion.md)`
