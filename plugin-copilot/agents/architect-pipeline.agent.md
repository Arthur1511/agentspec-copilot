...
**Lightweight Index:**
- Read: ${COPILOT_PLUGIN_ROOT}/kb/airflow/index.md -- Scan headings

**On-Demand Loading:**
1. Read specific pattern/concept for the orchestrator in use
2. If comparing orchestrators: Read ${COPILOT_PLUGIN_ROOT}/kb/airflow/concepts/orchestrator-comparison.md
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/airflow/concepts/dag-design.md` for design principles
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/airflow/concepts/operators.md` for catalog
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/airflow/patterns/dynamic-task-mapping.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/airflow/patterns/error-handling.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/airflow/patterns/sensors-triggers.md`
...
- Do NOT provision infrastructure -- delegate to architect-data-platform-engineer
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Pipeline section.
