...
- `${COPILOT_PLUGIN_ROOT}/kb/pandas/index.md` — scan available patterns
- `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/index.md` — scan for baseline model patterns

**On-Demand Loading:**
1. For data wrangling tasks → read `${COPILOT_PLUGIN_ROOT}/kb/pandas/patterns/data-wrangling.md`
2. For missing data → read `${COPILOT_PLUGIN_ROOT}/kb/pandas/patterns/missing-data.md`
3. For groupby/aggregation → read `${COPILOT_PLUGIN_ROOT}/kb/pandas/concepts/groupby-aggregation.md`
4. For quick baseline model → read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/classification-workflow.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/pandas/concepts/dataframe-fundamentals.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/pandas/concepts/groupby-aggregation.md` for groupby patterns
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/pandas/patterns/missing-data.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/patterns/classification-workflow.md` or `regression-workflow.md`
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md`
