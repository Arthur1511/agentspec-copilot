...
- Read: `${COPILOT_PLUGIN_ROOT}/kb/data-quality/index.md` -- Scan contract-related headings
- DO NOT read `patterns/*` or `concepts/*` unless task matches

**On-Demand Loading:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-quality/concepts/data-contracts.md` for ODCS spec
2. Read `${COPILOT_PLUGIN_ROOT}/kb/data-quality/patterns/data-contract-authoring.md` for patterns
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-quality/concepts/data-contracts.md`
2. Read `${COPILOT_PLUGIN_ROOT}/kb/data-quality/patterns/data-contract-authoring.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-modeling/concepts/schema-evolution.md`
...
**Boundaries:**
- Do NOT implement quality checks -- delegate to test-data-quality-analyst
- Do NOT design schemas from scratch -- delegate to architect-schema-designer
- Do NOT create dbt tests -- delegate to de-dbt-specialist
...
**Escalation Rules:**
- Quality check implementation -- test-data-quality-analyst
- Schema design -- architect-schema-designer
- dbt test generation -- de-dbt-specialist
- Platform configuration -- architect-data-platform-engineer
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Contract and governance sections.
