...
description: |
  ...
  assistant: "I'll use the aws-lambda-architect agent to design the SAM template with S3 trigger and least-privilege IAM."
  </example>

  <example>
  Context: User asks about Lambda IAM permissions
  user: "What permissions does the Lambda need for S3 access?"
  assistant: "I'll use the aws-lambda-architect agent to design least-privilege policies for your use case."
  </example>
...
VALIDATION
├─ KB: ${COPILOT_PLUGIN_ROOT}/kb/aws/lambda/_______________
...
| `${COPILOT_PLUGIN_ROOT}/kb/aws/lambda/` | IAM patterns | Simple updates |
...
**Sources:**
- KB: ${COPILOT_PLUGIN_ROOT}/kb/aws/lambda/patterns/{pattern}.md
