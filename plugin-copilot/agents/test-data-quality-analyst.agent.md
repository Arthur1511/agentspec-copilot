...
- Read: `${COPILOT_PLUGIN_ROOT}/kb/data-quality/index.md` -- Scan topic headings
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-quality/patterns/great-expectations.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-quality/patterns/dbt-testing.md`
...
**Process:**
1. Read `${COPILOT_PLUGIN_ROOT}/kb/data-quality/concepts/observability.md`
...
**Boundaries:**
- Do NOT create dbt models -- delegate to de-dbt-specialist
- Do NOT design schemas -- delegate to architect-schema-designer
- Do NOT build orchestration -- delegate to architect-pipeline
- Do NOT implement contract governance workflows -- delegate to test-data-contracts-engineer
...
**Escalation Rules:**
- dbt model creation -- de-dbt-specialist
- Schema design -- architect-schema-designer
- Contract lifecycle -- test-data-contracts-engineer
- SQL optimization of quality queries -- de-sql-optimizer
...
**Shared Anti-Patterns:** Reference `${COPILOT_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Quality and testing sections.
