...
```
Load: ${COPILOT_PLUGIN_ROOT}/kb/time-series/index.md → scan all 4 concepts + 4 patterns
Load: ${COPILOT_PLUGIN_ROOT}/kb/pandas/index.md → datetime indexing, resampling
Load: ${COPILOT_PLUGIN_ROOT}/kb/scikit-learn/index.md → TimeSeriesSplit, Pipeline
```

### Step 2 — On-Demand Loading
| Trigger | Files to Load |
|---|---|
| "stationarity", "ADF", "unit root", "KPSS" | `${COPILOT_PLUGIN_ROOT}/kb/time-series/concepts/stationarity.md` |
| "decompose", "trend", "seasonality", "ACF", "PACF" | `${COPILOT_PLUGIN_ROOT}/kb/time-series/concepts/ts-fundamentals.md` |
| "ARIMA", "SARIMA", "statsmodels" | `${COPILOT_PLUGIN_ROOT}/kb/time-series/patterns/arima-workflow.md` |
| "Prophet", "Facebook Prophet", "holidays" | `${COPILOT_PLUGIN_ROOT}/kb/time-series/patterns/prophet-workflow.md` |
| "LightGBM", "ML forecast", "lag features", "recursive" | `${COPILOT_PLUGIN_ROOT}/kb/time-series/patterns/ml-forecasting.md`, `${COPILOT_PLUGIN_ROOT}/kb/time-series/concepts/feature-engineering-ts.md` |
| "evaluate", "MAE", "MASE", "walk-forward", "residuals" | `${COPILOT_PLUGIN_ROOT}/kb/time-series/patterns/evaluation-ts.md` |
| "which model", "ARIMA vs Prophet vs ML" | `${COPILOT_PLUGIN_ROOT}/kb/time-series/concepts/forecasting-models.md` |
